...
public class JDBCUtils {
    ...
    private static String jdbcURL = "jdbc:mysql://localhost:3307/demo?useSSL=false";
...
//	}
    ...
    // 일반 날짜(자바날짜)를 SQL 날짜(목표날짜)로 변경
    public static Date getSQLDate(LocalDate date) {
    	return java.sql.Date.valueOf(date);
    }
    
    // SQL 날짜를 자바 날짜로 변경
    public static LocalDate getUrilDate(Date sqlDate) {
